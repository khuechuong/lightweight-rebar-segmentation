...
def get_InceptionV3_encoder(input_height=299,  input_width=299, include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000):
    ...
    if weights == 'imagenet':
        if include_top:
            ...
            weights_path = get_file('inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5', WEIGHTS_PATH_NO_TOP, cache_subdir='models')
